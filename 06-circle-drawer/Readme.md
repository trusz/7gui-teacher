...
\* Dialog control is explained in more detail in the paper [Developing GUI Applications: Architectural Patterns Revisited](http://ceur-ws.org/Vol-610/paper11.pdf) starting on page seven. The term describes the challenge of retaining context between successive GUI operations.
